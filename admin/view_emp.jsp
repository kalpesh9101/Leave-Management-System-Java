	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<a href="#" class="btn btn-info btn-block" style="border-radius:0%;" ><i class="fa fa-eye"></i> View Employees</a>
				</div>
				<div class="col-md"></div>
			</div>
		</div>
			...
			<div class="row">
				<table class="table table-bordered table-hover table-striped">
					...
					<tbody>
						...
						%>
						<tr bgcolor="#DEB887">
							<form action="update_emp.jsp" method="post">
								<input type="hidden" name="emp_id" value="<%=resultSet.getString("id") %>" >
							<td><%=count %></td>
							...
							<td>
								...
								<a href="delete_emp.jsp?emp_id=<%=resultSet.getString("id") %> " class="btn btn-danger">Delete</a>
							</td>
							</form>
						</tr>
						<% 
