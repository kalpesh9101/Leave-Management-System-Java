...
try 
{
	...
	resultSet1.next();
	int total1=resultSet1.getInt("total_leave");
	String sql2 ="SELECT * FROM leaves WHERE email=email";
	...
	<nav class="navbar navbar-toggleable-sm navbar-inverse bg-inverse p-0">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="mynavbar">
				...
				<!-- <ul class="navbar-nav">
					<li class="nav-item px-2"><a href="#" class="nav-link active">Balance Leave <%=bal %></a></li>
				</ul> -->
	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
					<a href="ApplyLeave.jsp" class="btn btn-primary btn-block" style="border-radius:0%;"  data-target="#addPostModal"><i class="fa fa-plus"></i> Apply Leave</a>
				</div>
				<div class="col-md-3">
			...
			<table class="table table-bordered table-hover table-striped">
							<thead>
							 ...
							 <tbody>
								...
								connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
								statement=connection.createStatement();
								String sql ="SELECT * FROM leaves WHERE email= '"+ email+"' ";
